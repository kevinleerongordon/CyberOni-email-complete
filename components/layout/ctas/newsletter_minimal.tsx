      ...
      <div className="container px-4 py-16 mx-auto lg:w-3/4 lg:flex lg:items-center lg:justify-between">
        ...
        <div className="mt-8 lg:mt-0">
          ...
          >
            ...
            <button
              type="submit"
              className="px-6 py-2 mx-2 text-sm tracking-wide text-white capitalize bg-blue-600 rounded-lg transition-colors duration-300 transform fo hover:bg-blue-500 focus:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80"
            >
              {buttonText}
            </button>
          </form>
