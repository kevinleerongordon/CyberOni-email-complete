...
export const BlogList = ({ blogs, slogans }: { blogs: blogType, slogans:Slogans }) => {
    ...
    function searchBlogsByKeyword(keyword: string): blogType{
        const filteredBlogs = blogs.filter(blog => {
            const lowerCaseContent = blog.content.toLowerCase();
    ...
    return (
        <section className="mt-8 bg-white dark:bg-gray-900">
            <div className="container px-6 py-10 mx-auto">
                ...
                <div className='text-center'>
                    <SearchBar onClear={clear_blogs} onSubmit={searchBlogsByKeyword} placeholder='Search Blogs'/>
                    <TagList tags={blog_tags} filterByTag={filterBlogsByTag} clearState={clear_blogs}/>
                </div>
                ...
                <div className="grid grid-cols-1 gap-8 mt-8 md:mt-16 md:grid-cols-2 xl:grid-cols-3">
                    {currentPosts.map((blog: blog, index: number) => (
                        <div key={index}>
                            ...
                            <p className="text-sm text-gray-500 dark:text-gray-400">{blog.content.substring(0, 150)}...</p>
